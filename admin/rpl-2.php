...
<head>
  <title>Hasil Kelulusan Kelas XII RPL </title>
  <meta charset="utf-8">
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <center>
          <h5>Kompetensi Keahlian: Rekayasa Perangkat Lunak (RPL)</h5>
        </center>
        <br>
        <!-- font ganti jenis -->
      </div>
    ...
    <table class="table table-bordered table-hover" id="domainsTable">
      ...
      $data = mysqli_query($koneksi, "SELECT
        ...
        nama_file,
        status
        from login where kode_kelas='rpl2'");
      while ($d = mysqli_fetch_array($data)) {
          ...
          <tr>
            ...
            <td>
              <center>
              <a type="button" class="btn btn-info btn-sm" href="../pdf/<?php echo $d['kode_kelas']; ?>/<?php echo $d['nama_file']; ?>" >Download</a>
            </td>
            <td>
              <center><a type="button" class="btn btn-warning btn-sm" href="edit.php?id=<?php echo $d['id']; ?>" >Edit</a>
            </td>
          </tr>
